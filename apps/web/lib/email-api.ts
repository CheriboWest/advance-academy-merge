...
/**
 * Send a saved outreach draft via the FastAPI backend (which relays through the
 * shared Google Workspace mailbox). Sends the signed-in coach's Supabase access
 * token as a Bearer token; the SMTP credentials live only on the backend.
 */
