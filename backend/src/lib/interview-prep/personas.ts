import type { InterviewerPersona, PersonaId } from '../../types/interview-prep.js';
...
export function getPersona(id: string): InterviewerPersona | undefined {
  return PERSONAS.find((p) => p.id === (id as PersonaId));
}
